          ...
          child: Column(
            children: <Widget>[ //back Button
              ...
              Container(
                ...
                child: const Column(
                  mainAxisAlignment: MainAxisAlignment.start, // Atur teks agar rata kiri
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 9),
                    Text('Please Sign in to access your account',style: TextStyle(
                        fontSize: 16,
              ...
              const Column(
                children: <Widget> [
                  CustomTextField(title: 'Email', hidetitle: 'Input Your Email'),
                  SizedBox(height: 6),
